...
export const translations = {
  'zh-CN': {
    ...
    geoAutoUpdate: 'GeoData 自动更新',
    geoAutoUpdateTip: '自动更新地理数据库（GeoIP、GeoSite 等）',
    geoUpdateInterval: '更新间隔',
    hours: '小时',
    geoxUrlSettings: 'GeoData 下载地址',
    geoxUrlTip: '留空使用默认地址',
    geoxUrlGeoipPlaceholder: 'GeoIP.dat 下载地址',
